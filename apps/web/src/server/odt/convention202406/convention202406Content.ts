    ...
    <office:body>
        <office:text text:use-soft-page-breaks="true">
            ...
            <text:p text:style-name="P32">
                <text:span text:style-name="Police_20_par_20_défaut">
                    <text:span text:style-name="T6">Nom de la structure</text:span>
                </text:span>
                <text:span text:style-name="Police_20_par_20_défaut">
                ...
                <text:span text:style-name="Police_20_par_20_défaut">
                    <text:span text:style-name="T7">Détail statut</text:span>
                </text:span>
                <text:span text:style-name="Police_20_par_20_défaut">
                    <text:span text:style-name="T4"></text:span>
                </text:span>
                <text:span text:style-name="Police_20_par_20_défaut">
                    <text:span text:style-name="T9">(association de loi de 1901, coopérative, autre…), situé(e)
                    </text:span>
                </text:span>
                <text:span text:style-name="Police_20_par_20_défaut">
                    <text:span text:style-name="T4"></text:span>
                ...
                <text:span text:style-name="Police_20_par_20_défaut">
                    <text:span text:style-name="T8">Nom du référent, fonction du référent</text:span>
                </text:span>
                <text:span text:style-name="Police_20_par_20_défaut">
                    <text:span text:style-name="T4">.</text:span>
                </text:span>
