...
export default {
  title:
    'Ressources/Cards/Ressource publiée dans une base/Actions éditeurs (créateurs et contributeurs)',
...
const PublishedPublicStory: Story = {
  args: {
    resource: { ...resource, published: date },
    user: creatorUser,
    isContributor: true,
  },
  render,
...
const PublishedPrivateStory: Story = {
  args: {
    resource: { ...resource, published: date, isPublic: false },
    user: creatorUser,
    isContributor: true,
  },
  render,
