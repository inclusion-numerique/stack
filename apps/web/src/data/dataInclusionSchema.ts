// https://www.data.inclusion.beta.gouv.fr/schemas-de-donnees-de-loffre/schema-des-structures-et-services-dinsertion/typologie-de-structures
...
export type DataInclusionTypologie = keyof typeof DataInclusionTypologies
// ⚠️ Peu de siret
export type DataInclusionStructure = {
  id: string
  nom: string
  // ⚠️ Souvent '00000000000000'
  siret: string
  /*
    * E.g.  'numerique',
