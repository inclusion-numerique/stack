  ...
  <div className="fr-container landing-main-container fr-my-8w">
    <div className="fr-grid-row fr-grid-row--center">
      <div className="fr-col-md-8">
        ...
        <ul>
          <li>
            <strong>inclusif</strong> : aisément appropriable par toutes et tous
            ;
          </li>
          <li>
        ...
        <p>
          ...
          inclusif, associations, structures de l&#39;ESS, élus, ou toute autre
          personne intéressée de près ou de loin par le numérique d&#39;intérêt
        ...
        <p>
          ...
          et toutes en faveur du développement d&#39;un numérique d&#39;intérêt
          général.
        </p>
        <p>
          <strong>
        ...
        <p>
          ...
          Services, Aidants Connect, Numérique en Commun[s]). Chaque utilisateur
          et utilisatrice est responsable du contenu qu&#39;il ou elle publie
          sur Les Bases.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            utilisatrice par une personne tierce, que cela soit sur Les Bases ou
        ...
        <p>
          ...
          effectuées et peut-être amenée à faire des demandes de modification ou
          de suppression à l&#39;éditeur ou l&#39;éditrice d&#39;une ressource,
          ou modifier ou supprimer elle-même une ressource le cas échéant.
        </p>
        <p>
          <strong>
            ...
            se réserve le droit de contacter le producteur ou la productrice de
            la ressource ou de la base concernée pour lui demander de la
