...
// import FollowBaseButton from './_components/FeaturedBase/FollowBaseButton'
import featuredBases from './_data/featured-bases.json'
import featuredResources from './_data/featured-ressources.json'
import featuredProfils from './_data/featured-profils.json'
      ...
      <div className="fr-container fr-pt-8w fr-pb-0 fr-py-md-10w">
        ...
        <div className="fr-text--center">
          <Link
            ...
            className="fr-btn fr-btn--lg fr-mt-6w "
          >
        ...
        <div className="fr-mt-6w fr-mt-md-10w fr-background-alt--yellow-tournesol fr-p-6w fr-grid-row fr-border-radius--16">
          ...
          <div className="fr-col-md fr-flex fr-direction-column">
            ...
            <p className="fr-flex fr-align-items-center">
              ...
              />
              <span>
                <span className="fr-text--bold">Collaborez</span> avec d’autres
                créateurs grâce aux bases
              </span>
            </p>
            <p className="fr-flex fr-align-items-center">
              <span
