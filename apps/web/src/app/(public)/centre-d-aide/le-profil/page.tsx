...
const ContentPolicyPage = () => (
  <div className="fr-container">
    ...
    <div className="fr-container landing-main-container fr-my-8w">
      <div className="fr-grid-row fr-grid-row--center">
        <div className="fr-col-md-8">
          ...
          <p>Votre profil est un espace personnel où vous pouvez accéder
            à toutes les ressources que vous avez créées, à vos
            collections, aux bases dont vous êtes membre ainsi qu’aux
            profils et aux bases que vous suivez.</p>
          <p>Votre profil, s’il est public, peut également être utilisé
            comme un espace personnel de publication.</p>
          <p>Un profil peut être <Link className="fr-page-title" href="">public</Link> (visible par tous les visiteurs) ou
            {" "} <Link className="fr-page-title"  href="">privé</Link>{" "}(visible uniquement par le créateur du profil).</p>
          <p>Lorsque vous vous inscrivez sur Les Bases du numérique
            d’intérêt général, un profil est automatiquement créé avec
            les informations que vous remplissez lors de votre
            inscription. Ce profil est donc personnel et individuel.</p>
          <Notice className="fr-mb-2w"
                  title=<div className="fr-text--regular"> <span className="fr-text-default--grey"><strong>À savoir pour les utilisateurs de la 1ère version de la plateforme</strong>
        <p>Si vous aviez créé une base personnelle, c’est-à-dire portant votre nom et
          prénom, et sur laquelle vous étiez le ou la seule à publier du contenu,
          celle-ci est automatiquement devenue un profil sur Les Bases.</p>
        </span></div>
      />
    <hr/>
    ...
    <ul>
      ...
      <li>Créez et publiez (si votre <Link className="fr-page-title"  href="">profil est public</Link>) directement vos ressources depuis votre profil</li>
    ...
    <p>Votre page de profil public est l'endroit où les visiteurs de la plateforme
      peuvent retrouver toutes vos ressources et collections publiques. Votre
      profil sera référencé dans le moteur de recherche de la plateforme et les
      visiteurs peuvent également vous suivre afin de retrouver plus facilement
      vos prochaines ressources publiées.</p>
    <p>Les visiteurs pourront également retrouver les informations que vous avez
      renseigné sur votre profil (prénom, nom, département, description) ainsi
      que les bases dont vous êtes membres et les bases et profils que vous
      suivez.</p>
    <p><strong>Retrouvez plus de détails sur la visibilité d’<span className="fr-page-title">un profil public ici.</span></strong></p>
    <Notice className="fr-mb-2w"
            title=<div className="fr-text--regular"> <span className="fr-text-default--grey">
<p>Si vous ne souhaitez pas utiliser votre profil comme un espace
   personnel de publication, vous pouvez modifier la visibilité
    de votre profil et passer à un profil privé.</p>
</span></div>
/>
<h4>Profil privé</h4>
...
<Notice className="fr-mb-2w"
        title=<div className="fr-text--regular"> <span className="fr-text-default--grey">
<p>Avec un profil “privé”, vous pouvez toujours devenir membre d’une base
et publier des ressources sur cette base. Vous pouvez donc toujours
participer à des espaces de publications communs.</p>
</span></div>
/>
<p>Avec un profil privé, vous n’avez donc plus la possibilité de publier des
  ressources directement depuis votre profil et votre page profil ne sera pas
  référencée dans le moteur de recherche de la plateforme. La visibilité de
  votre profil pour les visiteurs se limitera à votre nom et prénom.</p>
<p>Mis à part cette différence de visibilité, un profil privé vous donne accès aux
  mêmes usages qu’un profil public.</p>
<p><strong>Retrouvez plus de détails sur la visibilité d’<span className="fr-page-title ">un profil privé ici.</span></strong></p>
<hr/>
