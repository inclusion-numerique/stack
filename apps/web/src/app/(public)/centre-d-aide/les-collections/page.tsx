...
const ContentPolicyPage = () => (
  <>
    ...
    <div className="fr-container">
      <Breadcrumbs currentPage="Les Collections" />
    </div>
        ...
        <div className="fr-flex-grow-1 ">
          <div className="fr-container landing-main-container fr-my-8w">
            <div className="fr-grid-row fr-grid-row--center">
              <div className="fr-col-md-8">
                ...
                <img alt="" className="fr-width-full" src="/images/centre-d-aide/collections.svg"/>
                <h2 id="collection" className="fr-page-title ">Une collection, c’est quoi ?</h2>
                ...
                <hr/>
                <h2 id="creation-collection" className="fr-page-title ">Création d’une collection</h2>
                ...
                <img alt="" className="fr-width-full" src="/images/centre-d-aide/creation_collections.svg"/>
          ...
          <p>Vous pourrez modifier à tout moment les informations & les paramètres
             ...
             bouton <strong>‘Modifier’.</strong><Link href="#">En savoir plus ici</Link></p>
                ...
                />
                <h2 id="ressources-collection" className="fr-page-title ">Enregistrer des ressources dans une collection</h2>
...
avoir à passer par la création d’une collection.</p>
                ...
                />
                <h2 id="enregistrer-collection" className="fr-page-title ">Enregistrer une collection</h2>
                ...
                <h1 id="infos-collection" className="fr-page-title ">Informations & paramètres d’une collection</h1>
