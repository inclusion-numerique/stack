...
const AccessibilityStatementPage = () => (
  <div className="fr-container landing-main-container fr-my-8w">
    ...
    <p>
      Cette déclaration d’accessibilité s’applique à <strong>La Base</strong>{' '}
      <span>
        (<span>https://la-base.gouv.fr</span>)
      </span>
      .
    </p>
    <h2>État de conformité</h2>
    <p>
      <strong>La Base</strong> est{' '}
      <strong>
    ...
    <p>
      ...
      contacter le responsable de <span>La Base</span> pour être orienté vers
