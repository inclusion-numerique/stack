...
const category = 'Inclusion & compétences numériques'
        ...
        <div className="fr-container fr-container--medium">
          ...
          <div className="fr-my-6w fr-text--center">
            <h2 className="fr-text--sm fr-text--uppercase">
              Découvrez Les {categoriesCount[0].themes.length} thématiques{' '}
              {category}
            </h2>
            <ThematicTags
              className="fr-tag--green-archipel"
          ...
          <main id={contentId}>
            <SearchResults
              ...
              createPageLink={(page) =>
                createThematicLink(
                  'inclusion-et-competences-numeriques',
