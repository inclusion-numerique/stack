...
import { getStatistiquesGouvernanceRegion } from '@app/web/app/(with-navigation)/gouvernances/getStatistiquesGouvernances'
...
import { getListeGouvernanceRegion } from '@app/web/app/(with-navigation)/gouvernances/getListeGouvernances'
