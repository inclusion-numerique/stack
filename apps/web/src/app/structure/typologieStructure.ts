...
export const typologieStructureLabels: Record<string, string> = {
  ...
  CDAS: 'Centre départemental d’action sociale (CDAS)',
  ...
  EPN: 'Espace publique numérique (EPN)',
  ES: 'Épicerie solidaire (ES)',
  ESAT: 'Établissements ou services d’aide par le travail (ESAT)',
  ...
  HUDA: "Hébergement d'urgence pour demandeurs d'asile (HUDA)",
  LA_POSTE: 'La Poste',
