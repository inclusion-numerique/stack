...
import { getDepartementDashboardData } from '@app/web/app/(prefet)/prefet/[codeDepartement]/getDepartementDashboardData'
...
export const generateMetadata = async ({
  ...
  if (!user) {
    redirect(`/connexion?suivant=/prefet/${codeDepartement}`)
  }
