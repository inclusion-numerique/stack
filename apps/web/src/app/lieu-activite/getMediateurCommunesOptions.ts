...
export const getMediateurCommunesAndDepartementsOptions = async ({
  ...
  >`WITH initial_selection AS (SELECT COALESCE(
                               ...
                               FROM mediateurs
                                        LEFT JOIN cras_individuels
                                                  ON mediateurs.id = cras_individuels.cree_par_mediateur_id
                                        LEFT JOIN cras_collectifs
                                                  ON mediateurs.id = cras_collectifs.cree_par_mediateur_id
                                        LEFT JOIN cras_demarches_administratives
                                                  ON mediateurs.id = cras_demarches_administratives.cree_par_mediateur_id
    ...
    SELECT result_commune_code             as code,
