...
const ArchivesV1PageContent = ({
  ...
  if (v1Cras.empty) {
    return (
      <div className="fr-border fr-border-radius--8 fr-p-10v fr-flex fr-align-items-center fr-flex-gap-10v">
        <h2 className="fr-h6">Vos archives de compte-rendus d’activités</h2>
        <p>
