...
import type { CandidatsGouvernance } from '@app/web/app/(private-with-navigation)/gouvernances/getCandidatsGouvernances'
import BackLink from '@app/web/components/BackLink'
import CandidatPorteurCard from '@app/web/app/(private-with-navigation)/gouvernances/CandidatPorteurCard'
import styles from '@app/web/app/(private-with-navigation)/gouvernances/Gouvernances.module.css'
import ParticipantInfoAccordion from '@app/web/app/(private-with-navigation)/gouvernances/ParticipantInfoAccordion'
import {
