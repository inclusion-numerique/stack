...
import { ListeGouvernance } from '@app/web/app/(private-with-navigation)/gouvernances/getListeGouvernances'
import WhiteCard from '@app/web/ui/WhiteCard'
import GouvernanceCardCtas from '@app/web/app/(private-with-navigation)/gouvernances/GouvernanceCardCtas'
import GouvernanceCard from '@app/web/app/(private-with-navigation)/gouvernances/GouvernanceCard'
import { dateAsDay } from '@app/web/utils/dateAsDay'
import GouvernanceCompletedModal from '@app/web/app/(private-with-navigation)/gouvernances/GouvernanceCompletedModal'
