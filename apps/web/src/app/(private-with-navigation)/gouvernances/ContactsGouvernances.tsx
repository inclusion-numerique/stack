...
import type { ContactsGouvernance } from '@app/web/app/(private-with-navigation)/gouvernances/getContactsGouvernances'
...
import {
  contactTableHeaders,
  contactToData,
} from '@app/web/app/(private-with-navigation)/gouvernances//gouvernanceContactsTable'
import { addBadgeToContactData } from '@app/web/app/(private-with-navigation)/gouvernances/addBadgeToContactData'
