/* eslint unicorn/no-useless-promise-resolve-reject: 0, unicorn/no-empty-file: 0 */
//
...
// import type {
//   PremanenceConseillerNumerique,
// } from '@app/web/external-apis/conseiller-numerique/PremanenceConseillerNumerique'
