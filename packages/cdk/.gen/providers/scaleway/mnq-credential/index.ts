// https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential
...
export interface MnqCredentialConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#id MnqCredential#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#name MnqCredential#name}
  */
  readonly name?: string;
  /**
  * The ID of the Namespace associated to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#namespace_id MnqCredential#namespace_id}
  */
  readonly namespaceId: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#region MnqCredential#region}
  */
  readonly region?: string;
  /**
  * nats_credentials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#nats_credentials MnqCredential#nats_credentials}
  */
  readonly natsCredentials?: MnqCredentialNatsCredentials;
  /**
  * sqs_sns_credentials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#sqs_sns_credentials MnqCredential#sqs_sns_credentials}
  */
...
export interface MnqCredentialSqsSnsCredentialsPermissions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#can_manage MnqCredential#can_manage}
  */
  readonly canManage?: boolean | cdktf.IResolvable;
  /**
  * Allow publish messages to the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#can_publish MnqCredential#can_publish}
  */
  readonly canPublish?: boolean | cdktf.IResolvable;
  /**
  * Allow receive messages from the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#can_receive MnqCredential#can_receive}
  */
...
export interface MnqCredentialSqsSnsCredentials {
  ...
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#permissions MnqCredential#permissions}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential scaleway_mnq_credential}
*/
export class MnqCredential extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a MnqCredential resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the MnqCredential to import
  * @param importFromId The id of the existing MnqCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MnqCredential to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "scaleway_mnq_credential", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/mnq_credential scaleway_mnq_credential} Resource
  *
  * @param scope The scope in which to define this construct
