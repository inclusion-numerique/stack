// https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container
...
export interface ContainerConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#cpu_limit Container#cpu_limit}
  */
  readonly cpuLimit?: number;
  /**
  * This allows you to control your production environment
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#deploy Container#deploy}
  */
  readonly deploy?: boolean | cdktf.IResolvable;
  /**
  * The container description
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#description Container#description}
  */
  readonly description?: string;
  /**
  * The environment variables to be injected into your container at runtime.
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#environment_variables Container#environment_variables}
  */
  readonly environmentVariables?: { [key: string]: string };
  /**
  * HTTP traffic configuration
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#http_option Container#http_option}
  */
  readonly httpOption?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#id Container#id}
  *
  ...
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#max_concurrency Container#max_concurrency}
  */
  readonly maxConcurrency?: number;
  /**
  * The maximum of number of instances this container can scale to. Default to 20.
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#max_scale Container#max_scale}
  */
  readonly maxScale?: number;
  /**
  * The memory computing resources in MB to allocate to each container. Defaults to 128.
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#memory_limit Container#memory_limit}
  */
  readonly memoryLimit?: number;
  /**
  * The minimum of running container instances continuously. Defaults to 0.
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#min_scale Container#min_scale}
  */
  readonly minScale?: number;
  /**
  * The container name
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#name Container#name}
  */
  readonly name?: string;
  /**
  * The container namespace associated
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#namespace_id Container#namespace_id}
  */
  readonly namespaceId: string;
  /**
  * The port to expose the container. Defaults to 8080
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#port Container#port}
  */
  readonly port?: number;
  /**
  * The privacy type define the way to authenticate to your container
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#privacy Container#privacy}
  */
  readonly privacy?: string;
  /**
  * The communication protocol http1 or h2c. Defaults to http1.
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#protocol Container#protocol}
  */
  readonly protocol?: string;
  /**
  * The scaleway registry image address
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#registry_image Container#registry_image}
  */
  readonly registryImage?: string;
  /**
  * The sha256 of your source registry image, changing it will re-apply the deployment. Can be any string
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#registry_sha256 Container#registry_sha256}
  */
  readonly registrySha256?: string;
  /**
  * The secret environment variables to be injected into your container at runtime.
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#secret_environment_variables Container#secret_environment_variables}
  */
  readonly secretEnvironmentVariables?: { [key: string]: string };
  /**
  * The container status
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#status Container#status}
  */
  ...
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#timeout Container#timeout}
  */
  readonly timeout?: number;
  /**
  * timeouts block
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#timeouts Container#timeouts}
  */
  readonly timeouts?: ContainerTimeouts;
}
export interface ContainerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#create Container#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#default Container#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#delete Container#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#read Container#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container#update Container#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container scaleway_container}
*/
export class Container extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.21.0/docs/resources/container scaleway_container} Resource
  *
