// https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration
...
export interface ObjectBucketWebsiteConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  * The bucket name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration#bucket ObjectBucketWebsiteConfiguration#bucket}
  */
  readonly bucket: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration#id ObjectBucketWebsiteConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration#project_id ObjectBucketWebsiteConfiguration#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration#region ObjectBucketWebsiteConfiguration#region}
  */
  readonly region?: string;
  /**
  * error_document block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration#error_document ObjectBucketWebsiteConfiguration#error_document}
  */
  readonly errorDocument?: ObjectBucketWebsiteConfigurationErrorDocument;
  /**
  * index_document block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration#index_document ObjectBucketWebsiteConfiguration#index_document}
  */
...
export interface ObjectBucketWebsiteConfigurationErrorDocument {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration#key ObjectBucketWebsiteConfiguration#key}
  */
  readonly key: string;
}
...
export interface ObjectBucketWebsiteConfigurationIndexDocument {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration#suffix ObjectBucketWebsiteConfiguration#suffix}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration scaleway_object_bucket_website_configuration}
*/
export class ObjectBucketWebsiteConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObjectBucketWebsiteConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.31.0/docs/resources/object_bucket_website_configuration scaleway_object_bucket_website_configuration} Resource
  *
  * @param scope The scope in which to define this construct
